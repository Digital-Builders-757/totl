            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center">
                ...
                <nav className="hidden md:flex space-x-6">
                  <Link href="/admin/talent-dashboard" className="text-black font-medium">
                    Dashboard
                  </Link>
                  <Link
                    href="/admin/talent-dashboard/profile"
                    className="text-gray-600 hover:text-black"
                  >
                    Profile
                  </Link>
                  <Link
                    href="/admin/talent-dashboard/portfolio"
                    className="text-gray-600 hover:text-black"
                  >
                    Portfolio
                  </Link>
                  <Link
                    href="/admin/talent-dashboard/applications"
                    className="text-gray-600 hover:text-black"
                  >
                    Applications
                  </Link>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                    ...
                    <div className="flex space-x-2 mt-4 md:mt-0">
                      <Button asChild variant="outline">
                        <Link href="/admin/talent-dashboard/profile">Edit Profile</Link>
                      </Button>
                      <Button asChild className="bg-black text-white hover:bg-black/90">
