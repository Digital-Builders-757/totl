...
> Legacy design plan snapshot.
> For active auth rules and tests, use `docs/contracts/AUTH_BOOTSTRAP_ONBOARDING_CONTRACT.md` and `docs/tests/AUTH_BOOTSTRAP_TEST_MATRIX.md`.
