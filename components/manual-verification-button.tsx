...
export default function ManualVerificationButton({ userId, onVerified }: ManualVerificationButtonProps) {
  ...
  const handleVerification = async () => {
    ...
    try {
      ...
      const { error: profileError } = await supabase.from("profiles").update({ email_verified: true }).eq("id", userId)
