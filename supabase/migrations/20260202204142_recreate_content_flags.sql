-- Recreate moderation tooling if table drifted/missing
-- Purpose: ensure public.content_flags exists in remote environments
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE tgname = 'update_content_flags_updated_at'
  ) THEN
